	...
	public class DataSource
	{
		...
		private void createLists()
		{
			...
			supplierList = new List<Supplier>(){
					...
					new Supplier {SupplierName = "abc", Address = "147 rue Chasseur", City = "London", Country = "UK"},
					new Supplier {SupplierName = "Kotik", Address = "146 rue Chasseur", City = "Madrid", Country = "Spain"},
				};
